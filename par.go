...
// We use the name "PAR" as a synonym for "DO". In certain uses these
// alternate names read better. Specifically, when users import the
// package into their package namepsace via the "import ." construct
// the names PAR and PAR_FOR are the preferred interface. If the
// package is used more conventional manner the names par.DO and
// par.FOR are used.
//
var (
	PAR       = DO
